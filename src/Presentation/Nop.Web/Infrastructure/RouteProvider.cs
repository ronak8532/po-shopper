    ...
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("EstimateShipping",
                            ...
                            new[] {"Nop.Web.Controllers"}); //estimate shipping

            routes.MapLocalizedRoute("ProductEstimateShipping",
                            "cart/productestimateshipping",
                            new {controller = "ShoppingCart", action = "GetProductEstimateShipping" },
                            new[] {"Nop.Web.Controllers"});
            //wishlist
            ...
            routes.MapLocalizedRoute("SubmitOffer",
                            "submitoffer/",
                            new { controller = "ShoppingCart", action = "SubmitOffer" },
                            new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("CheckOffersExpiry",
                           "CheckOffersExpiry/",
                           new { controller = "Order", action = "CheckOffersExpiry" },
                           new[] { "Nop.Web.Controllers" });
            //vendor info
            routes.MapLocalizedRoute("CounterOffersInfo",
                            "customer/CounterOffersInfo/",
                            new { controller = "Customer", action = "CounterOffersInfo" },
                            new[] { "Nop.Web.Controllers" });
        }
